        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-5xl mx-auto">
          ...
          <div className="space-y-8">
            <div>
              ...
              <a href="tel:+79160313555" className="font-display text-3xl md:text-4xl font-bold gold-gradient hover:opacity-80 transition-opacity">
                +7 916 031 35 55
              </a>
              <p className="text-muted-foreground text-sm mt-1">Официальный номер для связи по вопросам помощи, консультаций и взаимодействия с программами реабилитации.</p>
            </div>
