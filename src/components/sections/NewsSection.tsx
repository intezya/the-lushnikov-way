  ...
  return (
    <section id="news" className="py-24 bg-secondary/30">
      <div className="container mx-auto px-4">
        ...
        <div className="section-fade-in flex justify-center gap-2 mb-10">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {filtered.map((n, i) => (
            <div key={i} className="section-fade-in group p-6 rounded-lg bg-card border border-border hover:border-primary/30 transition-all duration-500">
